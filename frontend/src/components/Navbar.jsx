    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        <NavLink to={'/'}>
          ...
          <hr className='border-none outline-none bg-indigo-600 h-0.5 w-3/5 m-auto hidden' />
        </NavLink>
        <NavLink to={'/doctors'}>
      ...
      <div className='flex items-center gap-4'>
        ...
        <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden top-0 right-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg fomt-medium'>
